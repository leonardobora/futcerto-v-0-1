    ...
    try {
      if (activeTab === "register") {
        ...
        await signUp(formData.email, formData.password, {
          name: formData.name,
          email: formData.email, // Make sure email is passed here as well for profile
      ...
      onClose();
      resetForm(); // Reset form on successful operation
    } catch (error: any) {
      toast({
            ...
            {!userType ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4 py-4">
                ...
                <div className="flex justify-end gap-2">
                  <Button type="button" variant="outline" onClick={() => setUserType(null)} disabled={isLoading}>
                    Voltar
                  </Button>
