            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm text-orange-700">
                  <strong>Modo Demonstração:</strong> Configuração do Supabase não encontrada. Algumas funcionalidades estarão limitadas.
                  Configure as variáveis VITE_SUPABASE_URL e VITE_SUPABASE_ANON_KEY para ativar todas as funcionalidades.
                </p>
              </div>
            </div>
          </div>
